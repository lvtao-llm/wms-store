 ...
 * @date 2025-11-11
 */
public class CoreAlarm extends BaseEntity
{
    ...
    /** 最高报警级别 */
    @Excel(name = "最高报警级别")
    private Long highestAlarmLevel;
    ...
    public void setHighestAlarmLevel(Long highestAlarmLevel) 
    {
        this.highestAlarmLevel = highestAlarmLevel;
    }

    public Long getHighestAlarmLevel() 
    {
