  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="预约区域编码的json数组[]" prop="areaCodes">
        <el-select v-model="queryParams.areaCodes" placeholder="请选择预约区域编码的json数组[]" clearable>
          <el-option
      ...
      <el-form-item label="定位卡ID" prop="cardId">
        <el-input
          v-model="queryParams.cardId"
          placeholder="请输入定位卡ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="gatepassList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="预约区域编码的json数组[]" align="center" prop="areaCodes">
        <template slot-scope="scope">
      ...
      <el-table-column label="定位卡ID" align="center" prop="cardId" />
      ...
      <el-table-column label="实际物资,json:{
     material_id       // 关联物料档案表记录ID即可得到出入库
     quantity          // 实际数量
     datetime          // 时间
     gate_in_photo     // 进入区域照片
     gate_out_photo    // 离开区域照片
  }" align="center" prop="actuals" />
      <el-table-column label="预约物资，json：{
     material_id       // 关联物料档案表记录的第一条，目的是取物资的参数
     quantity          // 预约数量
     area_code         // 预约的区域
  }" align="center" prop="plans" />
      ...
      <el-table-column label="进入时料场门口照片" align="center" prop="gatepassGateInPhoto" />
      ...
      <el-table-column label="离开时料场门口照片" align="center" prop="gatepassGateOutPhoto" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="预约区域编码的json数组[]" prop="areaCodes">
          <el-select v-model="form.areaCodes" placeholder="请选择预约区域编码的json数组[]">
            <el-option
              v-for="dict in dict.type.wms_area_name"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="定位卡ID" prop="cardId">
          <el-input v-model="form.cardId" placeholder="请输入定位卡ID" />
        </el-form-item>
        <el-form-item label="驾驶员姓名" prop="vehicleDriverName">
