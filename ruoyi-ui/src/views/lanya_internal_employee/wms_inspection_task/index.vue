<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="巡检规则ID" prop="ruleId">
        <el-input
          v-model="queryParams.ruleId"
          placeholder="请输入巡检规则ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="巡检规则名称" prop="ruleName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:wms_inspection_task:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:wms_inspection_task:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<script>
import { listWms_inspection_task, getWms_inspection_task, delWms_inspection_task, addWms_inspection_task, updateWms_inspection_task } from "@/api/system/wms_inspection_task"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getWms_inspection_task(id).then(response => {
