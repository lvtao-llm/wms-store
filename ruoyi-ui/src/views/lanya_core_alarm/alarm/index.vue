<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['lanya_core_alarm:alarm:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['lanya_core_alarm:alarm:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['lanya_core_alarm:alarm:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['lanya_core_alarm:alarm:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="alarmList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="报警区域ID" align="center" prop="areaId" />
      <el-table-column label="报警区域名称" align="center" prop="areaName" />
      ...
      <el-table-column label="绘制类型:0圆;1线;2多边形" align="center" prop="drawType" />
      ...
      <el-table-column label="报警人" align="center" prop="realName" />
      <el-table-column label="工号" align="center" prop="jobNumber" />
      <el-table-column label="管理人员姓名" align="center" prop="administratorName" />
      <el-table-column label="管理人员号码" align="center" prop="administratorPhone" />
      <el-table-column label="部门ID" align="center" prop="deptId" />
      <el-table-column label="部门名称" align="center" prop="deptName" />
      <el-table-column label="岗位id" align="center" prop="postId" />
      <el-table-column label="岗位名称" align="center" prop="postName" />
      <el-table-column label="所属承包商" align="center" prop="contractorId" />
      ...
      <el-table-column label="报警级别: 1/2/3级报警" align="center" prop="alarmLevel" />
...
<script>
import { listAlarm, getAlarm, delAlarm, addAlarm, updateAlarm } from "@/api/lanya_core_alarm/alarm"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('lanya_core_alarm/alarm/export', {
        ...this.queryParams
