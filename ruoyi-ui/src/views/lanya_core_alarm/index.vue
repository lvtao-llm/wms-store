...
<script>
import { listLanya_core_alarm, getLanya_core_alarm, delLanya_core_alarm, addLanya_core_alarm, updateLanya_core_alarm } from "@/api/system/lanya_core_alarm"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listLanya_core_alarm(this.queryParams).then(response => {
