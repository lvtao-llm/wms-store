...
public class DruidConfig {
    ...
    @Bean
    @ConfigurationProperties("spring.datasource.druid.storehouse")
    @ConditionalOnProperty(prefix = "spring.datasource.druid.storehouse", name = "enabled", havingValue = "true")
    public DataSource storehouseDataSource(DruidProperties druidProperties) {
        DruidDataSource dataSource = DruidDataSourceBuilder.create().build();
        return druidProperties.dataSource(dataSource);
    }
